...
public interface
    ITransactionListQueryModelMaterializer : IMaterializer<TransactionListQueryModel, Transaction, CardListQueryModel>
{
}

public class TransactionListQueryModelMaterializer : ITransactionListQueryModelMaterializer
{
    public TransactionListQueryModel Materialize(
        Transaction source1,
        CardListQueryModel source2
    )
    {
